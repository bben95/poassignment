...
const Profile = () => {
  // idividual data object and chat box hide unhide
    ...
    <div className="h-screen w-[74%] my-6 mr-4 relative">
      ...
      <div className="w-full flex mt-6">
        <div className=" w-[45%] flex  relative">
          <div className=" before:absolute before:inset-y-0 before:right-0 before:w-[1px] before:h-[100%] before:bg-neutral-300"></div>
          <div className="flex flex-col pr-4 items-center">
            <img
              src={individual.profilepicture}
              alt={individual.name}
              className=" w-[184px] h-[184px] max-w-[190px] max-h-[190px] rounded-full"
            />
            <p className="text-xl font-bold text-neutral-600 pt-1">
              {individual.name}
            </p>
            {/* left user profile details */}
            <div className="flex flex-row  border-b-[1px] border-neutral-300 gap-3 py-2 pl-4">
              ...
              <div className="flex flex-col  gap-2">
                ...
                <p className="text-xl font-bold  text-neutral-600 line-clamp-1 hover:line-clamp-none">
                  {individual.phone}
                </p>
                <p className="text-xl font-bold  text-neutral-600">
                  {individual.website}
            ...
            <div className="flex flex-row  gap-3">
              ...
              <div className="flex flex-col  ">
                ...
                <p className="text-xl font-bold  text-neutral-600 line-clamp-1 hover:line-clamp-none">
                  {individual.company.catchPhrase}
                </p>
                <p className="text-xl font-bold  text-neutral-600 line-clamp-2">
                  {individual.company.bs}
                </p>
              </div>
            </div>
          </div>
     ...
     {/* right profile section */}
        <div className="w-full pl-12">
          ...
          <div className="w-full px-8 py-2">
            <div className="flex flex-row gap-3">
              ...
              <div className="flex flex-col  gap-2">
                ...
                <p className="text-xl font-bold  text-neutral-600">
                  {individual.address.suite}
                </p>
                <p className="text-xl font-bold  text-neutral-600">
                  {individual.address.city}
                </p>
                <p className="text-xl font-bold  text-neutral-600">
                  {individual.address.zipcode}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="py-4 px-8 h-full">
            <img
              src={MapImage}
              alt="mapImage"
              className="w-[100%] h-[60%] rounded-3xl object-cover"
            />
            {/* geoloction section */}
      ...
      {login && <Logout />}
      {/* Chat list component integration */}
      <ChatBox />
      {/* Chat box component integration */}
      {chatopen && <Chat />}
    </div>
  );
};
